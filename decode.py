...
def read_args():
    ...
    parser.add_argument("-m", "--max_homopolymer", help="the largest number of nt in a homopolymer", default=4,
                        type=int, required=True)
    parser.add_argument("--mock", help="Don't decode droplets. Just evaluate correctness of data", default=False,
                        action='store_true')
    parser.add_argument("--max_hamming",
                        help="How many differences between sequenced DNA and corrected DNA to tolerate", type=int,
                        default=100)
    parser.add_argument("--max_line", help="If defined, number of lines to read", type=int, default=None)
    parser.add_argument("--size", help="The number of bytes of the data payload in each DNA string", default=32,
                        type=int)
    parser.add_argument("--rand_numpy",
                        help="Uses numpy random generator. Faster but not compatible with older versions",
    ...
    parser.add_argument("--aggressive",
                        help="Aggressive correction of errors using consensus in file building. Not tested",
